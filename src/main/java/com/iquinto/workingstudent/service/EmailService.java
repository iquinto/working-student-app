...
public class EmailService {
    ...
    public boolean sendMailWithAttachment(Student student, Employer employer, JobPost jobPost, Resume resume) {
        boolean sent;
        String to = employer.getEmail();
        String subject = "Plataforma WORKINGSTUDENT: Candidato para la oferta " + jobPost.getTitle();
        String body = generateBody(student, jobPost);

        String filename = "CV_" + student.getName() + "_" + student.getSurname() + ".pdf";

        final InputStreamSource fileIn = new ByteArrayResource(resume.getData());

        MimeMessagePreparator preparator = new MimeMessagePreparator() {
            public void prepare(MimeMessage mimeMessage) throws Exception {
                mimeMessage.setRecipient(Message.RecipientType.TO, new InternetAddress(to));
                mimeMessage.setFrom(new InternetAddress("infoworkingstudent@gmail.com"));
                mimeMessage.setSubject(subject);
                mimeMessage.setText(body);

                MimeMessageHelper helper = new MimeMessageHelper(mimeMessage, true);
                helper.addAttachment(filename, fileIn, "application/pdf");
    ...
    public boolean sendNotificationByEmail(Notification notification) {
        boolean sent;
    ...
    private String generateBodNotification(Notification notification) {
        ...
        String body = "<div id=\"app\">\n" +
                ...
                "</div>\n" +
                "<footer id=\"footer\">\n" +
                "<div class=\"container app-footer\">&nbsp;</div>\n" +
                "</footer>";
        return body;
    }
    ...
    private String generateBody(Student student, JobPost jobPost) {
        ...
        String body = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "  \n" +
                "    <style type=\"text/css\">\n" +
                "      table, td { color: #000000; } a { color: #cca250; text-decoration: none; } @media (max-width: 480px) { #u_content_heading_3 .v-container-padding-padding { padding: 10px 20px !important; } #u_content_heading_3 .v-font-size { font-size: 28px !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 22px 26px !important; } #u_content_heading_2 .v-container-padding-padding { padding: 22px 22px 10px !important; } #u_content_heading_2 .v-font-size { font-size: 24px !important; } }\n" +
                ...
                "<p style=\"font-size: 14px; line-height: 140%; text-align: center;\">&nbsp;</p>\n" +
                "<p style=\"font-size: 14px; line-height: 140%; text-align: center;\"><span style=\"font-size: 30px; line-height: 42px;\"><strong><span style=\"line-height: 42px; font-size: 30px;\">WORKING<span style=\"color: #e03e2d; line-height: 42px; font-size: 30px;\">STUDENT</span></span></strong></span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 140%; text-align: center;\">&nbsp;</p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                ...
                "    <strong>Solicitud relacionada con la Oferta de Empleo "+jobPost.getTitle()+" </strong>\n" +
                "  </h1>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px;\">Ha recibido un CV de  <b>"+student.getName()+ " " + student.getSurname() +"</b> para la oferta de trabajo <b>"+jobPost.getTitle()+"</b>. Muchas gracias por su colaboraci&oacute;n.</span></p>\n" +
                "<p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px;\">&iexcl;Hasta pronto!</span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <strong>Por favor comprueba el archivo adjunto</strong>\n" +
                "  </h1>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <strong>&iquest;Necesita algo m&aacute;s?</strong>\n" +
                "  </h1>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "        \n" +
                "  <div style=\"color: #444444; line-height: 170%; text-align: center; word-wrap: break-word;\">\n" +
                "    <p style=\"font-size: 14px; line-height: 170%;\"><span style=\"font-size: 16px; line-height: 27.2px;\">&iexcl;Cont&aacute;ctenos!</span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "        \n" +
                "<div align=\"center\">\n" +
                "  <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Montserrat',sans-serif;\"><tr><td style=\"font-family:'Montserrat',sans-serif;\" align=\"center\"><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"\" style=\"height:45px; v-text-anchor:middle; width:396px;\" arcsize=\"9%\" stroke=\"f\" fillcolor=\"#cca250\"><w:anchorlock/><center style=\"color:#FFFFFF;font-family:'Montserrat',sans-serif;\"><![endif]-->\n" +
                "    <a href=\"\" target=\"_blank\" style=\"box-sizing: border-box;display: inline-block;font-family:'Montserrat',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #cca250; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;\">\n" +
                "      <span style=\"display:block;padding:14px 33px;line-height:120%;\">977 656 235&nbsp; |&nbsp; infoworkingstudent@gmail.com</span>\n" +
                "    </a>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 18px; line-height: 25.2px;\"><strong>WorkingStudent</strong></span></p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
                ...
                "    <p style=\"font-size: 14px; line-height: 180%;\">Calle Acacies 29, 43850 Cambrils</p>\n" +
                "<p style=\"font-size: 14px; line-height: 180%;\">977 656 235</p>\n" +
                "  </div>\n" +
                "\n" +
                "      </td>\n" +
                "    </tr>\n" +
